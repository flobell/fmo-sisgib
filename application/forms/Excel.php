...
class Application_Form_Excel extends Fmo_Form_Abstract
{
...
///////////////////// DATOS DE INTERFAZ PROVEEDORES ///////////////////////////////  
        ...
        $eCliente = new Zend_Form_Element_Radio(self::E_CLIENTE);
        $eCliente->setLabel('Tipo de Cliente:')
                ->setDescription('')
                ->addMultiOption('PROVEEDORES', 'Proveedores')
                ->addMultiOption('TRABAJADORES', 'Trabajadores')
                ->setSeparator('');
                //->setValue('false');
 ...
 ////////// PARA CARGA POR EXCEL //////////////////////////////////      
        ...
        $eArchivo->addValidator('File_Size', false, array('min' => '1kB', 'max' => '8MB'))
                ...
                ->addValidator('File_Extension', false, 'xls,ods')
                ...
                if (empty($registros)) {
                    ...
                    foreach ($registros as $fila => $datos) {
                        ...
                        if($fila>1){
                            ...
                            $reg->tipo_cuenta = $datos[5]?$datos[5]:1;
